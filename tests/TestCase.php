...
namespace TallAndSassy\AppThemeBase\Tests;

use Illuminate\Database\Eloquent\Factories\Factory;
use Illuminate\Support\Facades\Route;
use Orchestra\Testbench\TestCase as Orchestra;
use TallAndSassy\AppThemeBase\AppThemeBaseServiceProvider;
...
class TestCase extends Orchestra
{
    ...
    public function setUp(): void
    {
        ...
        Factory::guessFactoryNamesUsing(
            fn (string $modelName) => 'TallAndSassy\\AppThemeBase\\Database\\Factories\\'.class_basename($modelName).'Factory'
        );

        // route prefix
        // this must match/sync with what was put in
        // tests/Feature/Http/Controllers/AppThemeBaseControllerTest.php/setup
    ...
    {
        return [
            AppThemeBaseServiceProvider::class,
        ];
    }
    ...
    public function getEnvironmentSetUp($app)
    {
        ...
        include_once __DIR__.'/../database/migrations/create_app_theme_base_table.php';
        (new \CreateAppThemeBaseTable())->up();
    }
}
